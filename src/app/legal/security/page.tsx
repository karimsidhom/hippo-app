  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><strong>Encryption at rest:</strong> AES-256 on the Supabase-managed Postgres cluster and Storage.</li>
        ...
        <li><strong>Third-party dependencies:</strong> auto-scanned via Dependabot.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Canadian data-residency option</strong> for institutional customers.</li>
