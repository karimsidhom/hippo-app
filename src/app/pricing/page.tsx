  ...
  return <main style={{ minHeight: "100vh", background: "#f4f6f3", color: "#10211b", padding: "24px" }}>
    ...
    <section style={{ maxWidth: 1060, margin: "0 auto", padding: "76px 0" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 320px), 1fr))", gap: 18, marginTop: 54 }}>
        ...
        <Plan name="Residency Program" price="Pilot pricing" copy="Operational tools for program directors, coordinators, and faculty." features={["Cohort and rotation dashboards", "Accreditation-ready reports", "Faculty assignment workflows", "Resident onboarding and administration", "Priority support and data review"]} cta="Start a program pilot" href="mailto:hello@hippomedicine.com?subject=Hippo%20program%20pilot" dark />
      </div>
