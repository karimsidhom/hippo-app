...
import { Shield, Users, BarChart2, Download, Trash2, User, ChevronRight, Zap, CreditCard, CheckCircle, AlertCircle, Sparkles, Sun, Moon, Monitor, Building2, MessageSquare, Send, KeyRound, X, Lock, Eye, EyeOff, Bell, Smartphone, FileSpreadsheet, Compass, Target } from "lucide-react";
...
const SUBROUTES = [
  ...
  { href: "/settings/targets", label: "Case targets & on-track projections", icon: Target },
