...
const PROCEDURE_NAME_PATTERNS: [RegExp, string][] = [
  ...
  // ── Andrology / sexual medicine (profiles live in regional libraries;
  //    keys without a profile in the active region are skipped safely) ──
  [/\bpenile\s+implant/i, "penile_prosthesis"],
  [/\bpenile\s+plication\b/i, "penile_plication"],
  [/\bnesbit\b/i, "penile_plication"],
  [/\bplaque\s+(incision|excision)/i, "peyronie_graft"],
  [/\bpeyronie/i, "peyronie_graft"],
  [/\bpriapism/i, "priapism"],
  [/\b(distal|proximal)\s+shunt/i, "priapism"],
  [/\bpenile\s+fracture/i, "penile_fracture"],
  [/\b(venous|crural)\s+ligation/i, "penile_venous_ligation"],
  [/\bvasovasostom/i, "vasal_reconstruction"],
  [/\bvaso-?epididymostom/i, "vasal_reconstruction"],
  [/\bepididymovasostom/i, "vasal_reconstruction"],
  [/\bvasectomy\s+reversal/i, "vasal_reconstruction"],
  [/\bvaricocele\s+ligation/i, "varicocelectomy"],
  [/\btestis\s+biops/i, "testis_biopsy"],
  [/\btesticular\s+biops/i, "testis_biopsy"],
  [/\btese\b/i, "testis_biopsy"],
  [/\bsperm\s+extraction/i, "testis_biopsy"],
  [/\bmale\s+(suburethral\s+)?sling/i, "male_sling"],
  [/\bmini-?jupette/i, "male_sling"],
  [/\bsimple\s+prostatectom/i, "simple_prostatectomy"],
  [/\bdorsal\s+slit/i, "dorsal_slit"],
  [/\bmeatotom/i, "meatotomy"],
  [/\burethrotomy\b/i, "urethral_dilation"],
  [/\bdviu\b/i, "urethral_dilation"],
  [/\burethral\s+(stricture\s+)?(balloon\s+)?dilat/i, "urethral_dilation"],
  [/\b(penile|duplex)\s+doppler/i, "penile_doppler"],
  [/\bdoppler\s+(ultrasound|evaluation)/i, "penile_doppler"],
  [/\bcavernosometr/i, "cavernosometry"],
  [/\bcavernosograph/i, "cavernosometry"],
  [/\bintracavernosal\s+injection/i, "ici_test"],
  [/\bintravesical\s+botox/i, "intravesical_botox"],
  [/\bintravesical\s+botulinum/i, "intravesical_botox"],
  [/\borchidectom/i, "orchiectomy"],
  [/\bscrotal\s+(exploration|contents)/i, "scrotal_exploration"],
  [/\btorsion\b/i, "scrotal_exploration"],
  [/\bspermatocel/i, "hydrocelectomy"],
  [/\bepididymal\s+cyst/i, "hydrocelectomy"],
  [/\bhydrocele\b/i, "hydrocelectomy"],
  [/\bepididymectom/i, "epididymectomy"],
  [/\bvesicovaginal\s+fistula/i, "vvf_repair"],
  [/\bclot\s+evacuation/i, "clot_evacuation"],
  [/\bcomplex\s+.*catheteri[sz]ation/i, "complex_catheterization"],
  [/\bfiliform/i, "complex_catheterization"],
];
